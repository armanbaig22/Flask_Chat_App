...
def update_room(rood_id, room_name):
    rooms_collection.update_one({'_id': ObjectId(rood_id)}, {'$set': {'name': room_name}})
    room_members_collection.update_many({'_id.room_id': ObjectId(rood_id)}, {'$set': {'room_name': room_name}})

# ObjectId: A unique identifier for MongoDB documents.
